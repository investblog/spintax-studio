...
> воспроизведены.
>
> **Следующие — R1-5 (четыре обязанности политики 11.16) и R1-7 (справка на 14 языках про
> Generate/Fix, чей ключ и куда уходит текст — словарём §4.5).** Затем R1-10 (WACK) и R1-9
> (сайт и подача, последним, решением владельца).
>
