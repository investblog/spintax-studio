...
> со страницей.
>
> **Следующий — R1-7: справка на 14 языках про Generate/Fix** — чей ключ, куда уходит текст,
> адрес не меняется без читателя, словарём §4.5; `HELP_UI_QUOTES` пополняется обеими
> кнопками, термины уже измерены в R1-4. Затем R1-10 (WACK заново — первый кандидат с
